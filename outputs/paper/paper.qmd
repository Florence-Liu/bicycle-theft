...
The dataset used in this analysis was obtained from Toronto's Open Data Portal and can be accessed from the package `opendatatoronto` [@citeOpendatatoronto]. The dataset `Bicycle Thefts` includes all bicycle theft occurrences reported to the Toronto Police Service from 2014 to 2022 [@citeData]. We use the latest `csv` version refreshed on Apr 4, 2023 in this analysis.


Since the occurrence of bicycle theft was self-reported, the reporter may choose to hide or inaccurately report some information and contributes to the reporting biases[@citeTorontopoliceservice]. Also, the location information is blurred due to privacy consideration.
