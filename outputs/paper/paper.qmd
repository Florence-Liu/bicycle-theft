...
The remainder of this paper is structured as follows: @sec-data discusses the data with @sec-data_introduction includes basic information about data collection and cleaning results, and @sec-data_visualization includes graphs and tables representing relationships between variables and some discussions.
...
data |> 
  ...
  ggplot(aes(x=as.factor(occ_year), fill=occ_month)) +
  geom_bar() +
...
#| fig-cap: Number of bicycle theft in different type of location in Toronto for each year from 2014 to 2022.
#| echo: false
#| warning: false
#| message: false
